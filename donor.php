...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['Add'])) {
    ...
    if ($id !== "" && $name !== "" && $group !== "" && $age !== "" && $sex !== ""
     && $ldd !== "" && $phone !== "" && $email !== "" && $add_date !== "" && $hospital_id !== "") {
        include_once('dbcon.php');
        $sql = "INSERT INTO donor (id,d_name,d_group,age,sex,ldd,phone,email,add_date,hospital_id)
                VALUES ('$id', '$name', '$group', '$age', '$sex', '$ldd', '$phone', '$email', '$add_date', '$hospital_id')";
include_once('dbcon.php');
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="text" name="d_name" id="" placeholder="Enter Name">
            <input type="text" name="d_group" id="" placeholder="Enter Group">
            <input type="text" name="age" id="" placeholder="Enter Age">
            </div>
            <div class="column">
            <input type="text" name="sex" id="" placeholder="Enter Sex">
            <input type="text" name="ldd" id="" placeholder="Enter ldd">
            <input type="text" name="phone" id="" placeholder="Enter Phone">
            <input type="text" name="email" id="" placeholder="Enter Email" required>
            </div>
            <div class="column">
            <input type="text" name="add_date" id="" placeholder="Enter Add Date">
