...
if (isset($_POST['Add'])) {
    ...
    if ( $l_name != "" && $email != "" && $l_address != "" && $phone != "" && $x != "" && $y != "" && $ion_user_id != "" && $hid != "") {

        include_once('dbcon.php');

        $sql = "INSERT INTO laboratorist( img_url, name, email, address, phone, x, y, ion_user_id, hospital_id)
                VALUES ( '$img_url', '$l_name', '$email', '$l_address', '$phone', '$x', '$y', '$ion_user_id', '$hid')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="file" name="img_url" id="" placeholder="choose image">
            <input type="text" name="name" id="" placeholder="enter category">
            <input type="text" name="email" id="" placeholder="enter patient">
            <input type="text" name="address" id="" placeholder="enter allocated_time">
            </div>
            <div class="column">
            <input type="tel" name="phone" id="" placeholder="enter deallocated_time">
            <input type="number" name="x" id="" placeholder="enter x">
            <input type="number" name="y" id="" placeholder="enter y">
            <input type="text" name="ion_user_id" id="" placeholder="ion_user_id">
            </div>
            <div class="column">
            <input type="" name="hospital_id" id="" placeholder="enter hospital id">
            </div>
