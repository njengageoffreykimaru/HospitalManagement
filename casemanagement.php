...
if (isset($_POST['Add'])) {
    ...
    // if ($id !="" && $number !="" && $category !="" && $patient !="" && $time !="" && $status && $x !=""  && $hid!="") {
        
    
    $sql="INSERT INTO case_management(id,pid,editor4,added_at,infotype,auth_id,time,date,tab)
     VALUES('$id','$pid','$editor4','$added_at','$infotype','$auth_id','$time','$date','$tab')";
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="number" name="pid" id="" placeholder="enter pid">
       <input type="text" name="editor4" id="" placeholder="editor4">
        <input type="datetime-local" name="added_at" id="" placeholder="Added at">
            </div>
            <div class="column">
