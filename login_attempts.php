...
$time =$_POST['time'];
    ...
    $sql="INSERT INTO login_attempts(id,ip_address,login,time)
     VALUES('$id','$ip_address','$login','$time')";
include_once('dbcon.php');
$query=mysqli_query($con,$sql) or die("error occured");
if ($query) {
...
<div class="sidebar">
    ...
    <div class="form">
       ...
       <input type="number" name="ip_address" id="" placeholder="ip_address">
        <input type="text" name="login" id="" placeholder="login">
         <input type="number" name="time" id="" placeholder="time">
            </div>
