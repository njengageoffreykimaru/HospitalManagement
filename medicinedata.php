...
if (isset($_POST['Add'])) {
    ...
    $sql="INSERT INTO medicinedata(id,pid,auth_id,medicine,dosage,status,reason,viewed,time)
     VALUES('$id','$pid','$auth_id','$medicine',' $dosage','$status',' $reason','$viewed','  $time')";
include_once('dbcon.php');
$query=mysqli_query($con,$sql) or die("data inserted successfully");
if ($query) {
    echo "$medicine Register successfull";
    ...
    <div class="form">
      ...
      <input type="number" name="pid" id="" placeholder="enter pid">
       <input type="number" name="auth_id" id="" placeholder="enter auth_id">
        <input type="text" name="medicine" id="" placeholder="enter medicine	">
            </div>
            <div class="column">
         <input type="text" name="dosage" id="" placeholder="enter dosage">
          <input type="text" name="status" id="" placeholder="enter status">
          <input type="text" name="reason" id="" placeholder="enter reason">
          
          <input type="text" name="viewed" id="" placeholder="enter viewed">
            </div>
            <div class="column">
          <input type="date" name="time" id="" placeholder="enter time">
            </div>
