...
if (isset($_POST['Add'])) {
    $id=$_POST['id'];
    $system_vendor=$_POST['system_vendor'];
    $title=$_POST['title'];
    ...
    $vat=$_POST['vat'];
    $codec_username=$_POST['codec_username'];
    $codec_purchase_code=$_POST['codec_purchase_code'];
    ...
    // if ($id !="" && $system_vendor !="" && $title !="" && $address!="" 
    // && $phone !=""  && $email !=""  && $facebook_id!=""  && $currency !="" 
    //  && $discount !=""  && $vat!="" && $codec_username !="" &&
    //   $codec_purchase_code !="" && $hospital_id !="") {
        
    
    $sql="INSERT INTO settings(
        id,system_vendor,title,address,phone,email,facebook_id,
        currency,discount,vat,codec_username,codec_purchase_code,	
        hospital_id)
     VALUES(
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="text" name="system_vendor" id="" placeholder="system_vendor">
       <input type="text" name="title" id="" placeholder="enter title">
        ...
        <input type="text" name="phone" id="" placeholder="enter phone">
          ...
          <input type="text" name="facebook_id" id="" placeholder="enter facebook_id">
         
          <input type="text" name="currency" id="" placeholder="enter 	currency">
            </div>
            <div class="column">
          <input type="text" name="discount" id="" placeholder="enter discount">
          <input type="text" name="vat" id="" placeholder="enter vat">
          <input type="text" name="codec_username" id="" placeholder="enter 	codec_username">

         
          <input type="text" name="codec_purchase_code" id="" placeholder="codec_purchase_code">
            </div>
            <div class="column">
          <input type="number" name="hospital_id" id="" placeholder="hospital_id">
            </div>
