...
if (isset($_POST['Add'])) {
    ...
    if ($id != "" && $pid != "" && $editor1  != "" && $infotype != "" && $auth_id != "" && $time != "" &&$date !="" &&$tab!="") {
        include_once('dbcon.php');

        $sql = "INSERT INTO notes_info (id, pid,editor1,infotype,auth_id,time,date,tab)
                VALUES ('$id', '$pid', '$editor1', '$infotype', '$auth_id','$time','$date','$tab')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="text" name="editor1" id="" placeholder="enter editor1">
