...
if (isset($_POST['Add'])) {
    ...
    if ($id != "" && $pid != "" && $medication	  != "" && $infotype != "" && $auth_id != "" && $time != "" &&$date !="" &&$tab!="") {
        include_once('dbcon.php');

        $sql = "INSERT INTO medication (id, pid,medication,infotype,auth_id,time,date,tab)
                VALUES ('$id', '$pid', 'medication', '$infotype', '$auth_id','$time','$date','$tab')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="text" name="medication" id="" placeholder="enter medication">
