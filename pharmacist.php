    ...
    if ($name != "" && $email != "" && $address != "" && $phone != "" && $x != "" && $y != "" && $ion_user_id != "" && $hospital_id != "") {
        ...
        if ($_FILES['img_url']['size'] > 0) {
            ...
            if (in_array($img_type, $allowed_types)) {
                ...
                $img_content = file_get_contents($img_tmp);
                
                // Escape special characters in the content
                $img_content = mysqli_real_escape_string($con, $img_content);

                // Insert the record into the database
                $sql = "INSERT INTO pharmacist (img_url, name, email, address, phone, x, y, ion_user_id, hospital_id)
                        VALUES ('$img_url', '$name', '$email', '$address', '$phone', '$x', '$y', '$ion_user_id', '$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="file" name="img_url" placeholder="img_url">
            ...
            <input type="number" name="ion_user_id" placeholder="ion_user_id">
            </div>
            <div class="column">
