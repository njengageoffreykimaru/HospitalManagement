...
if (isset($_POST['Add'])) {
    ...
    // if ($id != "" && $patientid != "" && $normal != "" && $pale != "" && $flushed != "" && $jaun != "" && $mottled != "" && $cyan != "" && $hot != "" && $warm != "" && $dry != "" && $diap != "" && $cold != "" && $elastic != "" && $decreased != "" && $tanting != "" && $smooth != "" && $scaly != "" && $other != "" && $sensory != "" && $moist != "" && $activity != "" && $mobility != "" && $nutrition != "" && $total != "" && $created_at != "" && $submit != "") {
        
        include_once('dbcon.php');
        $sql = "INSERT INTO skinassessment (id, patientid, normal, pale, flushed, jaun, mottled, cyan, hot, warm, dry, diap, cold, elastic, decreased, tanting, smooth, scaly, other, sensory, moist, activity, mobility, nutrition, total, created_at, submit) 
                VALUES ('$id', '$patientid', '$normal', '$pale', '$flushed', '$jaun', '$mottled', '$cyan', '$hot', '$warm', '$dry', '$diap', '$cold', '$elastic', '$decreased', '$tanting', '$smooth', '$scaly', '$other', '$sensory', '$moist', '$activity', '$mobility', '$nutrition', '$total', '$created_at', '$submit')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="number" name="patientid" id="" placeholder="Enter Patient ID">
            <input type="text" name="normal" id="" placeholder="Enter Normal">
            <input type="text" name="pale" id="" placeholder="Enter Pale">
            </div>
            <div class="column">
            <input type="text" name="flushed" id="" placeholder="Enter Flushed">
            <input type="text" name="jaun" id="" placeholder="Enter Jaundice">
            <input type="text" name="mottled" id="" placeholder="Enter Mottled">
            <input type="text" name="cyan" id="" placeholder="Enter Cyan">
            </div>
            <div class="column">
            <input type="text" name="hot" id="" placeholder="Enter Hot">
            <input type="text" name="warm" id="" placeholder="Enter Warm">
            <input type="text" name="dry" id="" placeholder="Enter Dry">
            <input type="text" name="diap" id="" placeholder="Enter Diap">
            </div>
            <div class="column">
            <input type="text" name="cold" id="" placeholder="Enter Cold">
            <input type="text" name="elastic" id="" placeholder="Enter Elastic">
            <input type="text" name="decreased" id="" placeholder="Enter Decreased">
            <input type="text" name="tanting" id="" placeholder="Enter Tanting">
            </div>
            <div class="column">
            <input type="text" name="smooth" id="" placeholder="Enter Smooth">
            <input type="text" name="scaly" id="" placeholder="Enter Scaly">
            <input type="text" name="other" id="" placeholder="Enter Other">
            <input type="text" name="sensory" id="" placeholder="Enter Sensory">
            </div>
            <div class="column">
            <input type="text" name="moist" id="" placeholder="Enter Moist">
            <input type="text" name="activity" id="" placeholder="Enter Activity">
            <input type="text" name="mobility" id="" placeholder="Enter Mobility">
            <input type="text" name="nutrition" id="" placeholder="Enter Nutrition">
            </div>
            <div class="column">
            <input type="text" name="total" id="" placeholder="Enter Total">
            <input type="date" name="created_at" id="" placeholder="Created At">
