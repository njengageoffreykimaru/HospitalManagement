...
if (isset($_POST['Add'])) {
    ...
    $last_a_time=$_POST['last_a_time'];
    $last_d_time=$_POST['last_d_time'];
    $status=$_POST['status'];
    $bed_id=$_POST['bed_id'];
    ...
    if ($id !="" && $category !="" && $number!="" && $description!=""
     && $last_a_time !="" && $last_d_time !=""&& $status !="" &&$bed_id !="" &&$hospital_id !="")  {
        
    
    $sql="INSERT INTO bed(id,category,number,description,last_a_time,last_d_time,status,bed_id,hospital_id)
     VALUES('$id','$category','$number','$description','$last_a_time','$last_d_time','$status','$bed_id','$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="text" name="category" id="" placeholder="enter category">
       <input type="text" name="number" id="" placeholder="enter number">
       <input type="text" name="description" id="" placeholder="enter description">
            </div>
            <div class="column">
       <input type="date" name="last_a_time" id="" placeholder="enter allocated_time">
          <input type="date" name="last_d_time" id="" placeholder="enter deallocated_time">
