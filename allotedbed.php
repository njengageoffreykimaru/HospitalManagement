...
if (isset($_POST['Add'])) {
    ...
    if ($id !="" && $number !="" && $category !="" && $patient !="" && $a_time !="" && $status && $x !=""  && $hid!="") {
        
    
    $sql="INSERT INTO alloted_bed(id,anumber,category,patient,a_time,d_time,astatus,x,hospital_id)
     VALUES('$id','$number','$category','$patient','$a_time','$d_time','$status','$x','$hid')";
include_once('dbcon.php');
$query=mysqli_query($con,$sql) or die("data inserted successfully");
if ($query) {
    echo "$hid Register successfull";
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="text" name="anumber" id="" placeholder="enter pid">
       <input type="text" name="category" id="" placeholder="enter category">
        <input type="text" name="patient" id="" placeholder="enter patient">
        </div>
            <div class="column">
         <input type="date" name="a_time" id="" placeholder="enter allocated_time">
          <input type="date" name="d_time" id="" placeholder="enter deallocated_time">
          <input type="text" name="astatus" id="" placeholder="enter status">
          
          <input type="text" name="x" id="" placeholder="enter x">
          </div>
            <div class="column">
          <input type="text" name="bed_id" id="" placeholder="enter bed id">
         
          <input type="text" name="hospital_id" id="" placeholder="enter hospital id">
            </div>
