...
$hospital_id=$_POST['hospital_id'];
    ...
    // if ($id !="" && $img_url !=""&& $name !="" && $email !="" &&$address !=""
    // &&$phone !=""&&$x !=""&&$ion_user_id !=""&&$hospital_id !="") {
        
    
    $sql="INSERT INTO accountant(id,img_url,name,email,address,phone,x,ion_user_id,hospital_id)
     VALUES('$id','$img_url','$name','$email','$address','$phone','$x','$ion_user_id','$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
        ...
        <input type="text" name="img_url" id="" placeholder="img_url">
         <input type="text" name="name" id="" placeholder="name">
          ...
          <input type="text" name="x" id="" placeholder="x">
          <input type="number" name="ion_user_id" id="" placeholder="ion_user_id">
          </div>
            <div class="column">
