...
if (isset($_POST['Add'])) {
    ...
    if ($id != "" && $pid != "" && $editor5 != "" && $added_at != "" && $infotype != "" && $auth_id != "" && $a_time != "" && $a_date != "") {
        include_once('dbcon.php');

        $sql = "INSERT INTO assessment_notes(id, pid, editor5, added_at, infotype, auth_id,time,date)
                VALUES ('$id','$pid','$editor5','$added_at','$infotype','$auth_id','$a_time', '$a_date')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="text" name="editor5" id="" placeholder="editor5">
            <input type="date" name="added_at" id="" placeholder="added_at">
            </div>
            <div class="column">

            <input type="text" name="infotype" id="" placeholder="info_type">
            <input type="number" name="auth_id" id="" placeholder="auth_id">
            <input type="time" name="time" id="" placeholder="a_time">
            <input type="date" name="date" id="" placeholder="a_date">
            </div>
