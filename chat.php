...
if (isset($_POST['Add'])) {
    ...
    if ($id !="" && $sender_id !=""&& $rec_id !="" && $sent_at !="" && $message !="") {
        
    
    $sql="INSERT INTO chat(id,sender_id,rec_id,sent_at,msg)
     VALUES('$id','$sender_id','$rec_id','$sent_at','$message')";
...
<div class="sidebar">
    ...
    <div class="form">
       ...
       <input type="text" name="sender_id" id="" placeholder="sender id">
        <input type="number" name="rec_id" id="" placeholder="receiver id">
         <input type="date" name="sent_at" id="" placeholder="time sent">
            </div>
            <div class="column">
          <input type="text" name="msg" id="" placeholder="message">
            </div>
