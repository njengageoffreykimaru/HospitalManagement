...
if (isset($_POST['Add'])) {
    ...
    if ($id !="" && $name !="" && $description !="" && $x !="" && $y !="" && $hospital_id !="") {
        
    
    $sql="INSERT INTO department(id,name,description,x,y,hospital_id)
     VALUES('$id','$name','$description','$x','$y','$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="text" name="name" id="" placeholder="enter department name">
