...
if (isset($_POST['Add'])) {
    ...
    $m_effects = $_POST['effects'];
    $e_date = $_POST['e_date'];
    $add_date = $_POST['add_date'];
    $hospital_id = $_POST['hospital_id'];

    if ($id != "" && $name != "" && $category != "" && $price != "" && $quantity != "" && $generic != "" &&
        $company != "" && $m_effects != "" && $e_date != "" && $add_date != "" && $hospital_id != "") {
    
        include_once('dbcon.php');

        $sql = "INSERT INTO medicine (id, name, category, price, quantity, generic, company, effects, e_date, add_date, hospital_id)
                VALUES ('$id', '$name', '$category', '$price', '$quantity', '$generic', '$company', '$m_effects', '$e_date', '$add_date', '$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="text" name="name" id="" placeholder="enter medicinename">
            ...
            <input type="text" name="generic" id="" placeholder="generic">
            <input type="text" name="company" id="" placeholder="company">
            <input type="text" name="effects" id="" placeholder="effects">
            </div>
            <div class="column">
            <input type="text" name="e_date" id="" placeholder="enter expiry date">
            <input type="text" name="add_date" id="" placeholder="add date">
