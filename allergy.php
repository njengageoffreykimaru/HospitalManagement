...
if (isset($_POST['Add'])) {
    ...
    // if ($id !="" && $pid !="" && $allergy !="" && $infotype !="" && $iauth_id&&$time !=""&&$date !="" &&$tab !="") {
        
    
    $sql="INSERT INTO allergy(id,pid,allergy,infotype,auth_id,time,date,tab)
     VALUES('$id','$pid','$allergy','$infotype','$iauth_id','$time','$date','$tab')";
include_once('dbcon.php');
$query=mysqli_query($con,$sql) or die("data inserted successfully");
if ($query) {
    echo "$id Register successfull";
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="text" name="allergy" id="" placeholder="enter allergy">
       <input type="text" name="infotype" id="" placeholder="enter infotype">
       </div>
            <div class="column">
        <input type="number" name="auth_id" id="" placeholder="enter authid">
         <input type="time" name="time" id="" placeholder="enter time">
          <input type="date" name="date" id="" placeholder="enter date">
          <input type="date" name="tab" id="" placeholder="enter tab">
            </div>
