...
if (isset($_POST['Add'])) {
    ...
    if ($id != "" && $name  != "" && $email!= "" && $password !="" && $address!= ""
      && $phone!= "" &&$ion_user_id!="" ) {
        ...
        $sql = "INSERT INTO hospital(id,name,email,password,address,phone,ion_user_id)
                VALUES ('$id','$name','$email','$password','$address','$phone','$ion_user_id')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="text" name="h_name" id="" placeholder="enter name">
            ...
            <input type="number" name="ion_user_id" id="" placeholder="enter ion_user_id">
            </div>
