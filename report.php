...
if (isset($_POST['Add'])) {
    ...
    if ($id !="" && $report_type !=""&& $patient !="" && $description !="" &&$doctor !=""&&$date !=""&&$add_date !=""&&$hospital_id !="") {
        
    
    $sql="INSERT INTO report(id,report_type,patient,description,doctor,date,add_date,hospital_id)
     VALUES('$id','$report_type','$patient','$description','$doctor','$date','$add_date','$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
       ...
       <input type="text" name="report_type" id="" placeholder="report_type">
        <input type="text" name="patient" id="" placeholder="patient">
         <input type="text" name="description" id="" placeholder="description">
            </div>
            <div class="column">
          <input type="text" name="doctor" id="" placeholder="doctor">
          <input type="date" name="date" id="" placeholder="date">
          <input type="date" name="add_date" id="" placeholder="add_date">
