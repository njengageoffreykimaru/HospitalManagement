...
if (isset($_POST['Add'])) {
    ...
    // if ( $pid != "" && $assess != "" && $noassess != "" && $explain != "" && $added_at != "") {
        include_once('dbcon.php');

        $sql = "INSERT INTO readiness_info(pid,assess,noassess,explanation,added_at)
                VALUES ('$pid','$assess','$noassess','$explanation','$added_at')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="text" name="noassess" id="" placeholder="enter noassess">
            <input type="text" name="explanation" id="" placeholder="enter explain">
            </div>
            <div class="column">
