...
if (isset($_POST['Add'])) {
   ...
   $auth_id=$_POST['auth_id'];
    ...
    if ($id !="" && $pid !="" && $physical !="" && $occupational !="" 
    && $dietary !=""  && $added_at!=""  && $infotype!="" 
     && $auth_id!=""  && $time!="" && $date !="" && $tab !="") {
        
    
    $sql="INSERT INTO therapy_notes(
        id,pid,physical,occupational,dietary,added_at,tab,infotype,auth_id,time,date)
     VALUES(
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="number" name="pid" id="" placeholder="pid">
       <input type="text" name="physical" id="" placeholder="enter physical">
        <input type="text" name="occupational" id="" placeholder="enter occupational">
            </div>
            <div class="column">
        <input type="text" name="dietary" id="" placeholder="enter dietary">
