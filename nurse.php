...
if (isset($_POST['Add'])) {
    ...
    if ($id != "" && $name != "" && $email != "" && $address != ""
        && $phone != "" && $x != "" && $y != "" && $z != "" && $ion_user_id != "" && $hospital_id != "") {
        include_once('dbcon.php');

        $sql = "INSERT INTO nurse (id, img_url, name, email, address, phone, x, y, z, ion_user_id, hospital_id)
                VALUES ('$id', '$img_url', '$name', '$email', '$address', '$phone', '$x', '$y', '$z', '$ion_user_id', '$hospital_id')";
        $query = mysqli_query($con, $sql) or die("Failed to insert data into the database");$query = mysqli_query($con, $sql) or die("Failed to insert data into the database: " . mysqli_error($con));
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <input type="file" name="img_url" id="" placeholder="Enter Image URL">
            ...
            <div class="column">
            <input type="number" name="z" id="" placeholder="Enter Z">
