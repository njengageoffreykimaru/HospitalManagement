...
$group_id=$_POST['group_id'];
    ...
    $sql="INSERT INTO users_groups(id,user_id,group_id)
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="number" name="user_id" id="" placeholder="user_id">
       <input type="number" name="group_id" id="" placeholder="enter group_id">
            </div>
