...
if (isset($_POST['Add'])) {
    ...
    if ($creator_id !== "" && $title !== "" && $description !== "" && $color !== "" && $start !== "" && $end !== "" && $allDay !== "") {
        include_once('dbcon.php');

        $sql = "INSERT INTO events (creator_id, title, description, color, start, end, allDay)
            VALUES ('$creator_id', '$title', '$description', '$color', '$start', '$end', '$allDay')";
...
<div class="sidebar">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <div class="column">
            <input type="number" name="creator_id" id="" placeholder="Enter category">
            ...
            <div class="column">
            <input type="date" name="start" id="" placeholder="Enter start">
            <input type="date" name="end" id="" placeholder="Enter end">
            <input type="text" name="allDay" id="" placeholder="Enter AllDay">
            </div>
