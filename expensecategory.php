...
if (isset($_POST['Add'])) {
    ...
    if ( $category !="" && $description !=""  && $x !="" && $y !="" && $hospital_id !="") {
        
    
    $sql="INSERT INTO expense_category(category,description,x,y,hospital_id)
     VALUES('$category','$description','$x','$y','$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="text" name="category" id="" placeholder="enter category">
          ...
          <input type="text" name="y" id="" placeholder="enter y">
             </div>
             <div class="column">
          <input type="number" name="hospital_id" id="" placeholder="enter hospital_id">
             </div>
