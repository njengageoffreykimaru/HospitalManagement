...
if (isset($_POST['Add'])) {
    ...
    $sql="INSERT INTO expense(category,date,amount,user,hospital_id)
     VALUES('$category','$date','$amount','$user','$hospital_id')";
...
<div class="sidebar">
    ...
    <div class="form">
      ...
      <input type="date" name="date" id="" placeholder="enter event date">

       <input type="text" name="amount" id="" placeholder="enter amount">
        <input type="text" name="user" id="" placeholder="enter user">
             </div>
